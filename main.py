    """
    Webhook Relay 8q91b1vq
    ======================
    Open-source API service that aggregates data between clients and backends.
    ...
    APP_NAME    = "Webhook Relay 8q91b1vq"
    APP_VERSION = "1.0.0"
...
return app
    ...
    def build_parser() -> argparse.ArgumentParser:
        p = argparse.ArgumentParser(prog=APP_NAME, description="Open-source API service that aggregates data between clients and backends.")
